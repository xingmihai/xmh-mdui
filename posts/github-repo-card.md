...
<mdui-card class="friend-card" style="padding: 16px; margin: 16px 0; cursor: pointer;" onclick="window.open('https://github.com/xingmihai/xmh-mdui', '_blank')">
  <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
    <mdui-avatar src="https://github.com/xingmihai.png" style="width: 48px; height: 48px;"></mdui-avatar>
    <div style="flex: 1; min-width: 0;">
      <div class="mdui-typescale-title-medium" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
        xingmihai / xmh-mdui
      </div>
      <div class="mdui-typescale-body-small" style="opacity: 0.6;">MDUI v2 个人博客主题</div>
    </div>
  ...
  <div style="display: flex; gap: 6px; align-items: center; flex-wrap: nowrap; overflow-x: auto;">
    <a href="https://github.com/xingmihai/xmh-mdui/stargazers" target="_blank" rel="noopener" style="display: inline-flex; flex-shrink: 0; line-height: 0;">
      <img src="https://img.shields.io/github/stars/xingmihai/xmh-mdui?style=flat&logo=github&label=Stars" alt="Stars" style="height: 20px; min-height: auto;">
    </a>
    <a href="https://github.com/xingmihai/xmh-mdui/network/members" target="_blank" rel="noopener" style="display: inline-flex; flex-shrink: 0; line-height: 0;">
      <img src="https://img.shields.io/github/forks/xingmihai/xmh-mdui?style=flat&logo=github&label=Forks" alt="Forks" style="height: 20px; min-height: auto;">
    </a>
    <a href="https://github.com/xingmihai/xmh-mdui/blob/main/LICENSE" target="_blank" rel="noopener" style="display: inline-flex; flex-shrink: 0; line-height: 0;">
      <img src="https://img.shields.io/github/license/xingmihai/xmh-mdui?style=flat" alt="License" style="height: 20px; min-height: auto;">
    </a>
  </div>
</mdui-card>
