...
<mdui-card class="friend-card" style="max-width: 480px; padding: 20px; margin: 16px 0; cursor: pointer;" onclick="window.open('https://github.com/xingmihai/xmh-mdui', '_blank')">
  ...
  <img src="https://img.shields.io/github/stars/xingmihai/xmh-mdui?style=social" alt="Stars" loading="lazy">
  <img src="https://img.shields.io/github/forks/xingmihai/xmh-mdui?style=social" alt="Forks" loading="lazy">
  <img src="https://img.shields.io/github/license/xingmihai/xmh-mdui" alt="License" loading="lazy">
</div>
</mdui-card>
