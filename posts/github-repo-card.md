...
<mdui-card class="friend-card" style="padding: 16px; margin: 16px 0; cursor: pointer;" onclick="window.open('https://github.com/xingmihai/xmh-mdui', '_blank')">
  ...
  <div style="display: flex; gap: 6px; align-items: center; flex-wrap: nowrap; overflow-x: auto;">
    <img src="https://img.shields.io/github/stars/xingmihai/xmh-mdui?style=flat&logo=github&label=Stars" style="height: 20px; width: auto; flex-shrink: 0; display: inline-block; min-height: auto;">
    <img src="https://img.shields.io/github/forks/xingmihai/xmh-mdui?style=flat&logo=github&label=Forks" style="height: 20px; width: auto; flex-shrink: 0; display: inline-block; min-height: auto;">
    <img src="https://img.shields.io/github/license/xingmihai/xmh-mdui?style=flat" style="height: 20px; width: auto; flex-shrink: 0; display: inline-block; min-height: auto;">
  </div>
</mdui-card>
